    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorySpecification", x => new { x.CategoriesId, x.SpecificationsId });
                    table.ForeignKey(
                        name: "FK_CategorySpecification_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategorySpecification_Specification_SpecificationsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductPrice = table.Column<decimal>(type: "decimal(18,2)", maxLength: 10, nullable: false),
                    ProductAmount = table.Column<int>(type: "int", maxLength: 10, nullable: false),
                    Product_id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsCarts_Carts_Cart_id",
                        column: x => x.Cart_id,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductsCarts_Products_Product_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategorySpecification_SpecificationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsCarts_Cart_id",
                table: "ProductsCarts",
                column: "Cart_id");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsCarts_Product_id",
                table: "ProductsCarts",
                column: "Product_id");
